...
class PersistentBottomNavBar extends StatelessWidget {
  ...
  final Function({required bool isAnimating, required bool isComplete})?
      onAnimationComplete;
  ...
  Widget build(final BuildContext context) => hideNavigationBar == null
      ...
      : OffsetAnimation(
          ...
          onAnimationComplete: ({required final isAnimating, required final isCompleted}) {
             onAnimationComplete!(
                isAnimating: isAnimating, isComplete: isCompleted);  
          },
          child: _navBarWidget(),
        );
  ...
  PersistentBottomNavBar copyWith(
      ...
      PersistentBottomNavBar(
          ...
          onAnimationComplete: onAnimationComplete as dynamic Function(
                  {required bool isAnimating, required bool isComplete})? ??
              this.onAnimationComplete,
