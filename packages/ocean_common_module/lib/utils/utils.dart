...
void showLoad({String? msg}) {
  EasyLoading.instance.backgroundColor = Colors.white.withAlpha(0);
  EasyLoading.instance.maskColor = Colors.white.withAlpha(0);
  EasyLoading.instance.indicatorColor = Colors.white.withAlpha(0);
  EasyLoading.instance.textColor = Colors.white.withAlpha(255);
  ...
  EasyLoading.instance.boxShadow = [
    BoxShadow(
      color: HzyNormalColorS.col000000.withAlpha(0),
    )
  ];
  EasyLoading.show(
