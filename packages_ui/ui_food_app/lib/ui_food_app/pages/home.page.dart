...
import 'widgets/most_popular_list.widget.dart';
import 'widgets/restaurants_list.widget.dart';
          ...
          child: BottomNavigationBar(
            ...
            items: const [
              BottomNavigationBarItem(
                  icon: Icon(CupertinoIcons.list_bullet), label: 'Home'),
              BottomNavigationBarItem(
                  icon: Icon(CupertinoIcons.bookmark), label: 'Favorites'),
              BottomNavigationBarItem(
