...
abstract class SAutoRoutePage<T> extends AutoRoutePage<T> {
  @override
  ...
  bool canUpdate(Page<dynamic> other) {
    return other.runtimeType == runtimeType &&
        (other as SAutoRoutePage).routeKey == routeKey;
  }
...
class MaterialPageX<T> extends SAutoRoutePage<T> {
  MaterialPageX({
...
class PageBasedMaterialPageRoute<T> extends PageRoute<T>
  ...
  PageBasedMaterialPageRoute({
    required SAutoRoutePage page,
  }) : super(settings: page);

  SAutoRoutePage get _page => settings as SAutoRoutePage;
...
mixin _NoAnimationPageRouteTransitionMixin<T> on PageRoute<T> {
  ...
  SAutoRoutePage<T> get _page => settings as SAutoRoutePage<T>;
...
abstract class _TitledAutoRoutePage<T> extends SAutoRoutePage<T> {
  final String? title;
...
class CustomPage<T> extends SAutoRoutePage<T> {
  @override
  final bool opaque;
