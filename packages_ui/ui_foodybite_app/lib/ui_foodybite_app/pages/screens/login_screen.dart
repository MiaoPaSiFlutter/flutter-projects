            ...
            children: <Widget>[
              ...
              Positioned(
                ...
                child: ListView(
                  children: <Widget>[
                    _buildHeader(),
                    const SizedBox(height: Sizes.HEIGHT_200),
                    _buildForm(context),
                    SpaceH36(),
      ...
      child: Column(
        children: <Widget>[
          ...
          Align(
            ...
            child: InkWell(
              onTap: () =>
                  AutoRouter.of(context).push(const ForgotPasswordScreen()),
              child: Container(
  ...
  Widget _buildFooter(BuildContext context) {
    return Column(
      children: <Widget>[
        PotbellyButton(
          StringConst.LOGIN,
          onTap: () => AutoRouter.of(context).push(RootScreen()),
        ),
        const SizedBox(height: Sizes.HEIGHT_60),
        InkWell(
          onTap: () => AutoRouter.of(context).push(const RegisterScreen()),
          child: Container(
