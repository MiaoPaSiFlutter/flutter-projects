...
class EmailStore with ChangeNotifier {
  ...
  static final _mainInbox = <Email>{
    Email(
      ...
      avatar: Utils.assets('images/paris_1.jpg'),
      recipients: 'Jeff',
    ...
    Email(
      ...
      message:
          ...
          'Talk to you soon,\n\n'
          'Ali',
      avatar: Utils.assets('images/paris_2.jpg'),
      recipients: 'Jeff',
      containsPictures: false,
    ),
    Email(
      ...
      avatar: Utils.assets('images/paris_3.jpg'),
      recipients: 'Jeff',
    ...
    Email(
      ...
      avatar: Utils.assets('images/paris_4.jpg'),
