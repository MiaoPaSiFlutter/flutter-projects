              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Image.asset(
                      Utils.assets('img/icons/notification.png'),
                      width: 32,
                      height: 32,
                    )
                  ],
          ...
          Positioned.fill(
            child: Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(32),
                child: Image.asset(
                  Utils.assets('img/posts/large/${category.imageFileName}'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
...
class _Story extends StatelessWidget {
            ...
            Stack(
              children: [
                ...
                Positioned(
                  ...
                  bottom: 0,
                  child: Image.asset(
                    Utils.assets('img/icons/${story.iconFileName}'),
                    width: 24,
                    height: 24,
                  ),
                )
  ...
  Widget _profileImage() {
    return ClipRRect(
      ...
      child: Image.asset(Utils.assets('img/stories/${story.imageFileName}')),
    );
  }
}
        ...
        child: Row(
          children: [
            ClipRRect(
              borderRadius: BorderRadius.circular(16),
              child: Image.asset(
                  Utils.assets('img/posts/small/${post.imageFileName}')),
            ),
            Expanded(
              child: Padding(
