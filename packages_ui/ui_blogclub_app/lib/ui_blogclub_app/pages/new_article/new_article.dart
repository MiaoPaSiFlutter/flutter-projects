            ...
            child: Container(
              ...
              child: Row(
                children: [
                  ...
                  SvgPicture.asset(Utils.assets('img/icons/image.svg')),
                  const SizedBox(
                    width: 20,
                  ),
                  SvgPicture.asset(Utils.assets('img/icons/play.svg')),
                  const SizedBox(
                    width: 20,
                  ),
                  SvgPicture.asset(Utils.assets('img/icons/align.svg')),
                  const SizedBox(
                    width: 20,
                  ),
                  SvgPicture.asset(Utils.assets('img/icons/link.svg')),
                  const SizedBox(
                    width: 20,
                  ),
                  SvgPicture.asset(Utils.assets('img/icons/scale.svg')),
                ],
              ),
            ),
          )
          ...
          children: [
            ...
            Container(
              ...
              child: SvgPicture.asset(
                Utils.assets('img/icons/close.svg'),
                width: 16,
                height: 16,
                color: themeData.colorScheme.primary,
              ),
