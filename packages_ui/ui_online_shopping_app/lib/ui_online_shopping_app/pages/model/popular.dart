...
final homePopularProducts = [
  Product(
    ...
    sold: 8374,
    price: 120.00,
    icon: Utils.assets('icons/products/foam_padded_chair@2x.png'),
  ),
  Product(
    ...
    sold: 7483,
    price: 145.40,
    icon: Utils.assets('icons/products/book_case@2x.png'),
  ),
  Product(
    title: 'Glass Lamp',
    star: 4.3,
    sold: 6937,
    price: 40.00,
    icon: Utils.assets('icons/products/lamp.png'),
  ),
  Product(
    title: 'Glass Package',
    star: 4.9,
    sold: 8174,
    price: 55.00,
    icon: Utils.assets('icons/products/class_package@2x.png'),
  ),
  Product(
    title: 'Plastic Chair',
    star: 4.6,
    sold: 6843,
    price: 65.00,
    icon: Utils.assets('icons/products/plastic_chair@2x.png'),
  ),
  Product(
    title: 'Wooden Chairs',
    star: 4.5,
    sold: 7758,
    price: 69.00,
    icon: Utils.assets('icons/products/wooden_chairs.png'),
  ),
];
