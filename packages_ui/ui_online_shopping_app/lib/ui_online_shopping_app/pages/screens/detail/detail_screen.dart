            ...
            CustomScrollView(
              slivers: [
                SliverAppBar(
                  ...
                  leading: IconButton(
                    icon: Image.asset(Utils.assets('icons/back@2x.png'),
                        scale: 2),
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background: Container(
                      ...
                      child: Image.asset(
                        Utils.assets('icons/products/detail_sofa.png'),
                        fit: BoxFit.none,
                      ),
                    ),
                  ),
    ...
    return <Widget>[
      Row(
        ...
        children: [
          ...
          IconButton(
            ...
            icon: Image.asset(Utils.assets(
                'icons/${_iscollected ? 'bold' : 'light'}/heart@2x.png')),
            iconSize: 28,
          ),
        ],
      ),
      ...
      Row(
        children: [
          ...
          Image.asset(Utils.assets('icons/start@2x.png'),
              height: 20, width: 20),
        ...
        Container(
          ...
          child: Material(
            ...
            child: Row(
              children: [
                InkWell(
                  child: Image.asset(Utils.assets('icons/detail/minus@2x.png'),
                      scale: 2),
                  onTap: () {
                ...
                const SizedBox(width: 20),
                InkWell(
                  child: Image.asset(Utils.assets('icons/detail/plus@2x.png'),
                      scale: 2),
          ...
          child: Material(
            ...
            child: InkWell(
              ...
              child: Row(
                ...
                children: [
                  Image.asset(Utils.assets('icons/detail/bag@2x.png'),
                      scale: 2),
                  const SizedBox(width: 16),
                  const Text(
                    'Add to Cart',
