...
class ProfileOption {
  ...
  ProfileOption.arrow({
    ...
    trailing ??
        Image(
          image: AssetImage(Utils.assets('icons/profile/arrow_right@2x.png')),
          width: 24,
          height: 24,
        );
  }
...
class _ProfileScreenState extends State<ProfileScreen> {
  static _profileIcon(String last) => Utils.assets('icons/profile/$last');
      ...
      trailing: SizedBox(
        ...
        child: Row(
          ...
          children: [
            ...
            Image.asset(Utils.assets('icons/profile/arrow_right@2x.png'),
                scale: 2)
          ],
        ),
      ));
