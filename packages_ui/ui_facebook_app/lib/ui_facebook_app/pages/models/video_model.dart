...
List<VideoModel> videoData = [
  VideoModel(
    ...
    avatarImage: Utils.assets("images/user/u1.jpg"),
    name: 'Prashant',
    time: 'Just Now',
    ...
    videoPostLink: "https://www.youtube.com/watch?v=TqMSUmkMjkE",
  ...
  VideoModel(
    avatarOnPressed: () => print('Avatar Clicked'),
    avatarImage: Utils.assets("images/user/u2.jpg"),
    name: 'Raj',
    time: '8 min ago',
    moreOnPressed: () => print('More Clicked'),
    videoPostTitle:
    ...
    videoPostLink: 'https://www.youtube.com/watch?v=ECGYAHDPLWw',
    likeOnPressed: () => print('Like Clicked'),
    commentOnPressed: () => print('Comment Clicked'),
    shareOnPressed: () => print('Share Clicked'),
  ),
  VideoModel(
    avatarOnPressed: () => print('Avatar Clicked'),
    avatarImage: Utils.assets("images/user/u3.jpg"),
    name: 'Vincenzo Cassano',
    time: '8 min ago',
    moreOnPressed: () => print('More Clicked'),
    videoPostTitle:
        'All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet.',
    videoPostLink: 'https://www.youtube.com/watch?v=INLr6Pzej6M',
    likeOnPressed: () => print('Like Clicked'),
    commentOnPressed: () => print('Comment Clicked'),
    shareOnPressed: () => print('Share Clicked'),
  ),
