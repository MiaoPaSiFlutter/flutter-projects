                  ...
                  children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: AssetImage(
                          Utils.assets('images/Profile Picture.png')),
                    ),
                  ],
                ),
              ),
                        ...
                        SizedBox(
                          ...
                          child: FittedBox(
                            ...
                            child: SvgPicture.asset(
                              Utils.assets('images/notifications_icon.svg'),
                            ),
                          ),
                        ),
                        Positioned(
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: FittedBox(
                          fit: BoxFit.fill,
                          child: SvgPicture.asset(
                            Utils.assets('images/send_icon.svg'),
                          ),
                        ),
                      ),
                    ...
                    children: [
                      SizedBox(
                        ...
                        child: FittedBox(
                          fit: BoxFit.fill,
                          child: SvgPicture.asset(
                            Utils.assets('images/request_icon.svg'),
                          ),
                        ),
                      ),
                      const HorizontalSpacer(width: 4),
  ...
  List<Widget> _buildTransactionsList() {
    if (transations.isNotEmpty) {
      ...
      return [
        ...
        SvgPicture.asset(Utils.assets("images/empty_illustration.svg")),
        const VerticalSpacer(height: 16),
        Text(
          ...
          Stack(
            ...
            children: [
              CircleAvatar(
                ...
                backgroundImage:
                    AssetImage(Utils.assets("images/${transaction.userImage}")),
              ),
              Positioned(
                left: 25.w,
                top: 25.h,
