...
class TreatItem {
  ...
  static List<TreatItem> mockItems = [
    TreatItem(
        ...
        image: Utils.assets('images/treat/TREAT_0.png'),
        colories: '2195 kJ',
        price: 6.34),
    TreatItem(
        id: '2',
        ...
        image: Utils.assets('images/treat/TREAT_1.png'),
        colories: '1292 kJ',
        price: 4.23),
    TreatItem(
        id: '3',
        ...
        image: Utils.assets('images/treat/TREAT_2.png'),
        colories: '1207 kJ',
        price: 3.23),
    TreatItem(
        id: '4',
        ...
        image: Utils.assets('images/treat/TREAT_3.png'),
        colories: '1252 kJ',
        price: 5.38),
    TreatItem(
        id: '5',
        ...
        image: Utils.assets('images/treat/TREAT_4.png'),
        colories: '2916 kJ',
        price: 6.69),
    TreatItem(
        id: '6',
        ...
        image: Utils.assets('images/treat/TREAT_5.png'),
        colories: '705 kJ',
        price: 3.13),
    TreatItem(
      id: '7',
      ...
      image: Utils.assets('images/treat/TREAT_6.png'),
      colories: '978 kJ',
      price: 5.13,
    ),
  ];
