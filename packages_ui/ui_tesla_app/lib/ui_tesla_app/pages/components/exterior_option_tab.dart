...
class _ExteriorOptionState extends State<ExteriorOption> {
  ...
  List<Image> carImages = [
    Image.asset(Utils.assets('images/tesla_black.png')),
    Image.asset(Utils.assets('images/tesla_midnight_blue.png')),
    Image.asset(Utils.assets('images/tesla_blue.png')),
    Image.asset(Utils.assets('images/tesla_white.png')),
    Image.asset(Utils.assets('images/tesla_red.png')),
  ];
