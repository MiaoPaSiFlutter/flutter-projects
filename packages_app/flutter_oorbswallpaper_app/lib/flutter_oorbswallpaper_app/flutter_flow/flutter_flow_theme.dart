...
class LightModeTheme extends FlutterFlowTheme {
  ...
  Color background = const Color(0xFF1A1F24);
  Color darkBackground = const Color(0xFF111417);
  Color textColor = const Color(0xFFFFFFFF);
  Color grayDark = const Color(0xFF57636C);
  Color grayLight = const Color(0xFF8B97A2);
  Color errorRed = const Color(0xFFF06A6A);
}
