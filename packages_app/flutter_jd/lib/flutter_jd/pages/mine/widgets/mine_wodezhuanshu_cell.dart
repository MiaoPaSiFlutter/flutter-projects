...
class MineWodezhuanshuCell extends StatelessWidget {
  final Map? floor;
  const MineWodezhuanshuCell({Key? key, this.floor}) : super(key: key);
  ...
  Widget _buildHeaderInfoView(BuildContext context) {
    return GestureDetector(
      child: const MidInfoHeaderView(labelName: "我的专属"),
      onTap: () {},
    );
  }
  ...
  Widget _buildGridView(BuildContext context) {
    return LayoutBuilder(
      builder: (p0, p1) {
        List orderList = floor?["data"]?["attentionList"] ?? [];
