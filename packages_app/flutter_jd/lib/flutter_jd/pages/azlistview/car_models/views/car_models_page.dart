  ...
  void loadData() async {
    rootBundle
        .loadString(NormalModuleUtils.configPackagesImage(
            ...
            name: 'assets/azlistview/data/car_models.json'))
        .then((value) {
    ...
    return Column(
      children: <Widget>[
        Container(
          color: Colors.white,
          padding:
              const EdgeInsets.only(left: 32, top: 20, right: 32, bottom: 16),
          child: Image.asset(
        ...
        Container(
          color: Colors.white,
          padding:
              const EdgeInsets.only(left: 32, top: 0, right: 32, bottom: 16),
          child: Image.asset(
