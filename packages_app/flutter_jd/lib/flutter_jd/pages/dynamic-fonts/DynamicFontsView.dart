...
class DynamicFontsView extends StatelessWidget {
  @override
...
class _FiraGoFile extends DynamicFontsFile {
  ...
  //https://github.com/bBoxType/FiraGO/tree/master/Fonts
  @override
  String get url {
    String url_ =
    ...
    url_ =
        'https://gitee.com/tommen-data/FiraGO/raw/master/Fonts/FiraGO_TTF_1001/$_dir/FiraGO-${variant.toApiFilenamePart()}.ttf';
    print(url_);
    return url_;
  }
}
