...
class BookContentResp {
  ...
  factory BookContentResp(jsonStr) => jsonStr is String
      ? BookContentResp.fromJson(json.decode(jsonStr))
      : BookContentResp.fromJson(jsonStr);

  BookContentResp.fromJson(jsonRes) {
    ok = jsonRes['ok'];
    chapter = jsonRes['chapter'] == null
        ? null
        : BookChapterContent.fromJson(jsonRes['chapter']);
  }
