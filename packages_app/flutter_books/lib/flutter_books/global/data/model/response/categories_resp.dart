...
class CategoriesResp {
  ...
  factory CategoriesResp.fromJson(Map<String, dynamic> srcJson) =>
      _$CategoriesRespFromJson(srcJson);

  Map<String, dynamic> toJson(CategoriesResp instance) =>
      _$CategoriesRespToJson(instance);
}
