...
class BookChaptersResp {
  ...
  factory BookChaptersResp(jsonStr) {
    return jsonStr is String
        ? BookChaptersResp.fromJson(json.decode(jsonStr))
        : BookChaptersResp.fromJson(jsonStr);
  }
  ...
  BookChaptersResp.fromJson(jsonRes) {
    ...
    for (var chaptersItem in chapters!) {
      chapters?.add(BookChaptersBean.fromJson(chaptersItem));
    }
  }
