...
import '../compontents/chat_widget.dart';
import '../compontents/drop_down.dart';
      ...
      return Container(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            backgroundColor:
                imagesProvider.imageList[imagesProvider.index].appBarColor,
            automaticallyImplyLeading: false,
            title: Image.asset(
              AppImages.aiLogoWhite,
              height: 100,
            ),
            actions: [
                  ...
                  child: Consumer2<ModelsProvider, SendMessageProvider>(builder:
                    ...
                    return Row(
                      children: [
                        ...
                        IconButton(
                            onPressed: sendMessageProvider.isAnimate
                                ? null
                                : () async {
