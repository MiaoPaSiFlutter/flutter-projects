...
class _ThemeScreenState extends State<ThemeScreen> {
  ...
  void didChangeDependencies() {
    precacheImage(AssetImage(AppImages.blueTheme), context);
    precacheImage(AssetImage(AppImages.pinkTheme), context);
    precacheImage(AssetImage(AppImages.purpleTheme), context);
    precacheImage(AssetImage(AppImages.whiteTheme), context);
    precacheImage(AssetImage(AppImages.greenTheme), context);
