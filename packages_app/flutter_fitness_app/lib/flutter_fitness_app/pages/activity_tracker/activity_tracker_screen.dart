...
class ActivityTrackerScreen extends StatefulWidget {
  static String routeName = "/fitness_app/ActivityTrackerScreen";
...
class _ActivityTrackerScreenState extends State<ActivityTrackerScreen> {
  ...
  List latestArr = [
    {
      "image": Utils.assets("images/pic_4.png"),
      "title": "Drinking 300ml Water",
      "time": "About 1 minutes ago"
    },
    {
      "image": Utils.assets("images/pic_5.png"),
                      ...
                      children: [
                        Expanded(
                          child: TodayTargetCell(
                            icon: Utils.assets("icons/water_icon.png"),
                            value: "8L",
                            title: "Water Intake",
                          ),
                        ),
                        ...
                        Expanded(
                          child: TodayTargetCell(
                            icon: Utils.assets("icons/foot_icon.png"),
                            value: "2400",
                            title: "Foot Steps",
                          ),
                        ),
