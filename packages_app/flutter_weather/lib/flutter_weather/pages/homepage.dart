                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                                image: AssetImage(Utils.assets(
                                    "images/${_response!.weatherInfo.icon}.jpeg")),
                                fit: BoxFit.cover),
                          ),
                                        ...
                                        child: Column(
                                          children: [
                                            Padding(
                                              ...
                                              child: Image(
                                                image: AssetImage(Utils.assets(
                                                    'icons/${_response!.weatherInfo.icon}.png')),
                                                fit: BoxFit.none,
                                              ),
                                            ),
                                            Text(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Stack(
                                                                                ...
                                                                                children: [
                                                                                  Image(
                                                                                    image: AssetImage(Utils.assets("icons/${cityWeatherHr[index].weather[0].icon}.png")),
                                                                                    height: 30,
                                                                                    width: 33,
                                                                                  ),
                                        ...
                                        child: Column(
                                          children: [
                                            Padding(
                                              ...
                                              child: Image(
                                                image: AssetImage(Utils.assets(
                                                    'icons/${cityWeather[cityIndex].cityIcon}.png')),
                                                fit: BoxFit.none,
                                              ),
                                            ),
                                            Text(
