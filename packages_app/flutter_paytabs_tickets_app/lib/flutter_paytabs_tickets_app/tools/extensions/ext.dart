...
import 'package:flutter_paytabs_tickets_app/flutter_paytabs_tickets_app/pages/payment/payment_states.dart';
...
extension SharedEvents on WidgetRef {
  ...
  String getMarkerIcon(Event event) {
    if (event.label == 'sports') {
      return Utils.assets('images/sport_marker.png');
    } else if (event.label == 'art') {
      return Utils.assets('images/sport_marker.png');
    } else {
      return Utils.assets('images/music_marker.png');
    }
  }
}
