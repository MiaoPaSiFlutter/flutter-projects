  ...
  configNormalData() {
    popList = [
      ...
      NormalDialogModel(
        ...
        space: 10,
        layoutType: 2,
        sureBgColor: OceanCommonColor().col000000,
        sureTitleColor: OceanCommonColor().whitebackgroundColor,
        sureMsg: "我是确认按钮",
      ),
      ...
      NormalDialogModel(
        title: tile,
        msg: msg,
        dialogBackColor: OceanCommonColor().colefedf3,
      ),
  ...
  tapItem({required int index}) {
    ...
    showNormalDialog(
      ...
      config: DialogConfig(
        ...
        titleColor: dialogModel.titleColor ?? OceanCommonColor().col000000,
        msgWidget: dialogModel.msgWidget,
        msgColor: dialogModel.msgColor ?? OceanCommonColor().col5a5a5a,
        ...
        cancelTitleColor:
            dialogModel.cannerTitleColor ?? OceanCommonColor().colplacetextcolor,
