...
class AnimationHeroShowImgpagePage extends StatelessWidget {
  ...
  buildCustomRoute({required Widget tagChild}) {
  ...
  buildCustomRoute2({required Widget tagChild}) {
    return PageRouteBuilder<void>(
      //背景透明方式打开
      opaque: false,
      //打开页面的过渡时间
      ...
      pageBuilder: (BuildContext context, Animation<double> animation,
        ...
        return AnimatedBuilder(
          ...
          builder: (BuildContext context, Widget? child) {
            return Opacity(
              opacity: const Interval(0.0, 0.75, curve: Curves.fastOutSlowIn)
...
class DetailsPage extends StatelessWidget {
  ...
  const DetailsPage(
      {super.key, required this.imageName, required this.description});
