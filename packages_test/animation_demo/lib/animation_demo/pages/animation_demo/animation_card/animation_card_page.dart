...
class AnimationCardPage extends StatefulWidget {
  const AnimationCardPage({Key? key}) : super(key: key);

  @override
  State<AnimationCardPage> createState() => AnimationCardPageState();
}

class AnimationCardPageState extends State<AnimationCardPage>
