...
class TestBluePainterPage extends StatefulWidget {
  const TestBluePainterPage({Key? key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<TestBluePainterPage> {
  int _counter = 0;
...
class BluePainter extends CustomPainter {
  ...
  BluePainter({required this.color}) {
