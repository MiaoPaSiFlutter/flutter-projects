...
class _SpinnerState extends State<Spinner> with SingleTickerProviderStateMixin {
  ...
  Offset _c1 = const Offset(1.0, 0.5);
  Offset _c2 = const Offset(0.75, 0.5);
  Offset _c3 = const Offset(0.5, 0.5);
  Offset _c4 = const Offset(0.25, 0.5);
  Offset _c5 = const Offset(0.0, 0.5);
  ...
  void initState() {
    ...
    AnimationSet animationSet = AnimationSet(_controller!);

    _controller?.addListener(() {
      if (_controller!.value < 0.8) {
        _c1 = animationSet.c1p1.value;
      } else {
        _c1 = animationSet.c1p2.value;
      }

      if (_controller!.value < 0.6) {
        _c2 = animationSet.c2p1.value;
      } else if (_controller!.value < 0.8) {
        _c2 = animationSet.c2p2.value;
      } else {
        _c2 = animationSet.c2p3.value;
      }

      if (_controller!.value < 0.4) {
        _c3 = animationSet.c3p1.value;
      } else if (_controller!.value < 0.6) {
        _c3 = animationSet.c3p2.value;
      } else {
        _c3 = animationSet.c3p3.value;
      }

      if (_controller!.value < 0.2) {
        _c4 = animationSet.c4p1.value;
      } else if (_controller!.value < 0.4) {
        _c4 = animationSet.c4p2.value;
      } else {
        _c4 = animationSet.c4p3.value;
      }

      if (_controller!.value < 0.2) {
        _c5 = animationSet.c5p1.value;
      } else {
        _c5 = animationSet.c5p2.value;
      }
...
class AnimationSet {
  static const Curve _curveOfCurve = Cubic(.51, .23, .8, .38);

  AnimationSet(this.controller)
      :
        // ********** C1 **********
        c1p1 = _OffsetTween(const Offset(1.0, 0.5), const Offset(0.0, 0.5))
        ...
        // ********** C2 **********
        c2p1 = _OffsetTween(const Offset(0.75, 0.5), const Offset(0.0, 0.5))
            .animate(CurvedAnimation(
          parent: controller,
          curve: const Interval(
            0.0,
        ...
        c2p3 = _OffsetTween(const Offset(1.0, 0.5), const Offset(0.75, 0.5))
            .animate(
          CurvedAnimation(
            parent: controller,
            curve: const Interval(
        ...
        // ********** C3 **********
        c3p1 = _OffsetTween(const Offset(0.5, 0.5), const Offset(0.0, 0.5))
            .animate(CurvedAnimation(
          parent: controller,
          curve: const Interval(
            0.0,
        ...
        c3p3 = _OffsetTween(const Offset(1.0, 0.5), const Offset(0.5, 0.5))
            .animate(
          CurvedAnimation(
            parent: controller,
            curve: const Interval(
        ...
        // ********** C4 **********
        c4p1 = _OffsetTween(const Offset(0.25, 0.5), const Offset(0.0, 0.5))
            .animate(CurvedAnimation(
          parent: controller,
          curve: const Interval(
            0.0,
        ...
        c4p3 = _OffsetTween(const Offset(1.0, 0.5), const Offset(0.25, 0.5))
            .animate(
          CurvedAnimation(
            parent: controller,
            curve: const Interval(
        ...
        c5p2 = _OffsetTween(const Offset(1.0, 0.5), const Offset(0.0, 0.5))
            .animate(
          CurvedAnimation(
            parent: controller,
            curve: const Interval(
...
class _CurveTween extends Tween<Offset> {
  static const Rect _bounds = Rect.fromLTWH(0, 0, 1, 1);
...
class _OffsetTween extends Tween<Offset> {
  ...
  Offset lerp(double t) {
    return Offset.lerp(begin, end, t) ?? const Offset(0, 0);
  }
}

class _SpinnerPainter extends CustomPainter {
  static const Color _mango = Color(0xffffbe0b);
  static const Color _orange = Color(0xfffb5607);
  static const Color _winterSky = Color(0xffff006e);
  static const Color _blueViolet = Color(0xff8338ec);
  static const Color _azure = Color(0xff3a86ff);
