...
class TestShakeAnimationPage2 extends StatefulWidget {
  const TestShakeAnimationPage2({super.key});

  @override
  _TestPageState createState() => _TestPageState();
}

class _TestPageState extends State<TestShakeAnimationPage2> {
  //用户名输入框的焦点控制
  ...
  //抖动动画控制器
  final ShakeAnimationController _userNameAnimation =
      ShakeAnimationController();

  final ShakeAnimationController _userPasswordAnimation =
      ShakeAnimationController();
