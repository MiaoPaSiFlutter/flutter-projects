...
class _TestABPageState extends State {
  ...
  ///倒计时时间
  final double _totalProgress = 10000;
  ...
  void initState() {
    ...
    _mainLooptimer = Timer.periodic(
        Duration(milliseconds: (_totalProgress + 1000).toInt()), (timer) {
      print("循环");
      startTimer();
    });
  }
  ...
  final StreamController<double> _streamTimeController = StreamController();
